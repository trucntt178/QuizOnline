...
public class LoadSubjectServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String url = "chooseSubjectPage";
        try {
            TblSubjectDAO dao = new TblSubjectDAO();
            dao.loadSubject();
            List<TblSubjectDTO> subjectList = dao.getSubjectList();
            if (subjectList != null) {
            ...
            url = "errPage";
            log("LoadSubjectServlet_Naming " + ex.getMessage());
        } catch (SQLException ex) {
            url = "errPage";
            log("LoadSubjectServlet_SQL " + ex.getMessage());
        } finally {
